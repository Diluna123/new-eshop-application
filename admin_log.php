        ...
        <div class="row vh-100 justify-content-center align-items-center">
            ...
            <div class="col-10 col-lg-4  signin " id="signin">
                ...
                <div class="col-lg-12 d-none ">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button class="btn btn-warning mt-3 col-12 " onclick="">Continue </button>
                ...
                <div class="col-lg-12">
                    <h3 class="text-center mb-4 mt-3">Admin Login Verification</h3>
                    <p class="form-text text-center text-secondary">Enter Your Registerd Admin Email Address to get Verfication code and login to your admin dashboard</p>



                    <label for="" class="form-label">Verification code :</label>
                    <input class="form-control border-warning mb-3" type="email" name="" id="l-email" value="" placeholder="Verification code" onclick="hideAlert();">
                    ...
                    <div class="row">
                    <div class="col-lg-12">
                            <button class="btn btn-outline-warning mt-3 col-12 " onclick="">Back </button>

                        </div>
                        <div class="col-lg-12">
                            <button class="btn btn-warning mt-2 col-12 " onclick="">Log in </button>
