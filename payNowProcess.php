...
if ($cartNum > 0) {
    ...
    for ($x = 0; $x < $cartP->num_rows; $x++) {
        ...
        Database::iud("INSERT INTO `invoice_items` (`qty`, `p_tot`, `invoice_order_num`, `products_p_id`, `rivew_status_rs_id`) VALUES ('" . $cartData["cart_qty"] . "', '" . $total . "', '$orderNum' ,'" . $cartData["products_p_id"] . "', '1')");
    }
    echo ("success");
} else {
    echo ("No Products You Selected");
}
