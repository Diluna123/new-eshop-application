                        ...
                        <div id="cartItems">
                            ...
                            ?>
                                <div class="card mb-1 d-grid" style="max-width: 100%; ">
                                    <div class="col-12">
                                        <input type="checkbox" id="itemCheck<?php echo $e; ?>" <?php if ($cartData["cart_s"] == 1) {
                                                                                                    echo "checked";
                                                                                                } ?> onclick="updateCartStatus(<?php echo $cartData['idcart']; ?>, <?php echo $e; ?>)" class="form-check-input position-absolute mt-2 ms-2  ">
                                        <div class="row g-0">
                                        ...
                                        <div class="card border-warning">
                                            ...
                                            <div class="card-text text-warning">
                                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">
                                                    <i class="fas fa-pen text-warning " onclick="window.location.href = 'user-profile.php'"></i>
