...
if (isset($_SESSION["user"])) {
    ...
    Database::iud("INSERT INTO `invoice` (`order_num`, `date`, `total`, `shipping_fees`, `cutomer_details_id` ,`order_status_id`, `pay_method_mid`,`ad_order_s_ad_o_s`) VALUES ('$onum', '$date', '$ftot', '300', '" . $_SESSION["user"]["id"] . "', '1', '1','1')");
